...
class MountainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mountain" do
    assert_difference('Mountain.count') do
      post mountains_url, params: { mountain: { comment: @mountain.comment, name: @mountain.name, place: @mountain.place } }
    end
  ...
  test "should update mountain" do
    patch mountain_url(@mountain), params: { mountain: { comment: @mountain.comment, name: @mountain.name, place: @mountain.place } }
